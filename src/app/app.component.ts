...
getColor(element: any): string {
  // Assign colors based on atomic number
  if (element.atomicNumber <= 10) {
    return 'pink'; // Group 1 - Jade
  } else if (element.atomicNumber <= 20) {
    return 'blue'; // Group 2 - Blue
  } else if (element.atomicNumber <= 30) {
    return 'green'; // Group 3 - Green
  } else if (element.atomicNumber <= 40) {
    return 'purple'; // Group 4 - Purple
  } else if (element.atomicNumber <= 50) {
    return 'orange'; // Group 5 - Orange
  } else if (element.atomicNumber <= 60) {
    return 'yellow'; // Group 6 - Yellow
  } else if (element.atomicNumber <= 70) {
    return 'cyan'; // Group 7 - Cyan
  } else if (element.atomicNumber <= 80) {
    return 'magenta'; // Group 8 - Magenta
  } else if (element.atomicNumber <= 90) {
    return 'teal'; // Group 9 - Teal
  } else {
    return 'violet'; // Group 10 - Brown
  }
}
}
